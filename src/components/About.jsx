      ...
      <div className="container">
        ...
        <div className="about-grid">
          ...
          <div className="glass-card about-story-card">
            ...
            <p className="story-paragraph">
              During my <strong>1-year tenure at Hindustan Aeronautics Limited (HAL)</strong>, I conducted hardware & software integration testing for <strong>Autopilot control systems on Kiran Mk II aircraft</strong>. Subsequently, during my <strong>2+ years at Universal Electricals & Electronics (UEE India)</strong>, I engineered <strong>5 production websites</strong> (featuring full-stack mining platforms like <em>ueeindia.com</em> & <em>mining.skoriyatech.com</em> with custom Admin Dashboards), published a live <strong>Google Play Store Mobile App (UEEindia)</strong>, provided enterprise IT support, and prepared technical audit reports for <strong>SANY heavy equipment</strong>.
            </p>
